...
function GlobalPage() {
  ...
  OVERVIEW_TOKEN_BLACKLIST.forEach((blacklistedTokenId) => {
    !!allTokens[blacklistedTokenId] && delete allTokens[blacklistedTokenId]
  })

  PAIR_BLACKLIST.forEach((blacklistedPairId) => {
    !!allPairs[blacklistedPairId] && delete allPairs[blacklistedPairId]
  })
      ...
      <ContentWrapper>
        <div>
          <AutoColumn gap="24px" style={{ paddingBottom: below800 ? '0' : '24px' }}>
            <TYPE.largeHeader>{below800 ? 'Protocol Analytics' : 'PartySwap Protocol Analytics'}</TYPE.largeHeader>
            <Search />
            <GlobalStats />
          </AutoColumn>
