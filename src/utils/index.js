...
export function getSwapLink(token0Address, token1Address = null) {
  if (!token1Address) {
    return `https://app.partyswap.io/#/swap?inputCurrency=${token0Address}`
  } else {
    return `https://app.partyswap.io/#/swap?inputCurrency=${token0Address === WAVAX_ADDRESS ? 'AVAX' : token0Address
